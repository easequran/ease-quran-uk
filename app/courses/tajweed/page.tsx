...
export const metadata: Metadata = {
  ...
  description: "Online Tajweed classes in the UK with a certified teacher. Learn to recite the Quran correctly with proper pronunciation and Tajweed rules. Free trial available.",
...
export default function Tajweed() {
  return (
    <CoursePageTemplate
      title="Online Tajweed Classes UK"
      ...
      description="Tajweed is the science of reciting the Quran correctly — with proper pronunciation of each letter, accurate application of elongation rules, and the beautiful precision that the Quran deserves. Our online Tajweed classes in the UK help students move from simply reading to truly reciting the Quran as it was revealed."
      learn={[
      ...
      faqs={[
        ...
        { q: "How long does a Tajweed course take?", a: "A foundational Tajweed course covering all the main rules typically takes 6–12 months at 2 classes per week. Students can then continue to refine their recitation further." },
