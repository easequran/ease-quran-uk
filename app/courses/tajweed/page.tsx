...
export default function Tajweed() {
  return (
    <CoursePageTemplate
      ...
      howWorks="Our quran tajweed classes online follow a clear, logical curriculum built around one structured science. Each one-to-one session focuses on a specific set of Tajweed rules, applied immediately to real Quranic verses. Your teacher Muhammad Umair, a Tajweed specialist, listens to your recitation, identifies errors, explains the rule behind each correction, and ensures you can apply it independently before moving on. Sessions are live, online, and approximately 30 minutes long, making this online tajweed course as easy to fit into a UK routine as it is thorough."
      faqs={[
