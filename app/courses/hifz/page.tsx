...
export default function Hifz() {
  return (
    <CoursePageTemplate
      ...
      howWorks="Hifz requires consistency above all else. Our online Hifz course is available up to 5 days per week so students can maintain a daily memorisation routine. Each one-to-one session blends new memorisation (sabaq), recent revision (sabaqi), and periodic review of older portions (manzil) with genuine quran recitation classes online, so pronunciation is corrected as new verses are learned, not after. Your teacher Muhammad Umair is a Tajweed and Hifz specialist who understands how to keep students motivated, correct errors early, and ensure what is memorised stays memorised. Parents are kept informed of progress at regular intervals."
      faqs={[
