...
export default function NooraniQaida() {
  return (
    <CoursePageTemplate
      ...
      slug="noorani-qaida"
      image="/courses/noorani-qaida-classes-online.webp"
      ...
      learn={[
        ...
        "Gradual progression at a pace that suits each student",
      ]}
      whoFor={[
      ...
      faqs={[
        { q: "What age can children start the Noorani Qaida course?", a: "Children as young as 4 can begin, though we recommend 5 and above for the best learning experience. The right age depends on the child's ability to focus, your teacher will assess this in the free trial." },
        ...
        { q: "How long does the Noorani Qaida course take to complete?", a: "This varies by student, but on average 3 to 6 months of regular classes. The priority is accuracy over speed." },
