...
export const metadata: Metadata = {
  title: "Online Islamic Studies Classes UK — Kids & Adults",
  ...
  return (
    <CoursePageTemplate
      ...
      learn={[
        ...
        "Seerah — the life of the Prophet Muhammad (ﷺ) and Companions",
      ...
      whoFor={[
        "Children aged 5+ who are ready to learn about their faith",
      ...
      faqs={[
        ...
        { q: "Can Islamic Studies be combined with Quran lessons?", a: "Yes. Many families book both Quran Reading or Tajweed and Islamic Studies. We can help create a timetable that covers both." },
