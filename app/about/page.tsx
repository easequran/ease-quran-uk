...
export default function About() {
  return (
    <>
      {/* Hero */}
      <section className="bg-[#0B1E5B] pt-12 pb-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="relative aspect-video rounded-3xl overflow-hidden shadow-xl">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#0B1E5B]/40 to-transparent" />
            </div>
            <div>
              <span className="inline-block text-xs font-bold uppercase tracking-widest text-[#F5A623] mb-3">Why We Started</span>
              <h2 className="text-3xl md:text-4xl font-bold text-[#0B1E5B] mb-5 leading-snug">We built Ease Quran because trust was missing</h2>
              <div className="space-y-4 text-gray-700 leading-relaxed">
                ...
                <p>Ease Quran was built to fill that gap. Every decision we make is guided by one question: <strong className="text-[#0B1E5B]">would I trust this for my own child?</strong></p>
      ...
      <section className="section-pad bg-[#faf9f7]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#0B1E5B]">Our Values</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {values.map((v) => (
              <div key={v.title} className="bg-white rounded-3xl border-2 border-[#0B1E5B]/10 p-7 hover:border-[#F5A623]/50 hover:shadow-md transition-all duration-300 group">
                ...
                <h3 className="font-bold text-[#0B1E5B] mb-2">{v.title}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#0B1E5B] mb-1">Shah Zaib</h2>
      ...
      <section className="section-pad bg-[#faf9f7]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#0B1E5B]">Meet the Teachers</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 max-w-3xl mx-auto">
            {[
              ...
              <div key={t.name} className="relative bg-white rounded-3xl border-2 border-[#0B1E5B]/10 px-8 pt-12 pb-7 hover:border-[#F5A623]/50 hover:shadow-lg transition-all duration-300 group flex flex-col items-center text-center">
                ...
                <div className="relative w-24 h-24 rounded-full mb-4 p-0.5 bg-gradient-to-br from-[#F5A623] to-[#0B1E5B]">
                  <div className="w-full h-full rounded-full overflow-hidden">
                    <Image src={t.img} alt={`${t.name}, ${t.role}`} width={96} height={96} className="object-cover object-top w-full h-full" />
                  </div>
                </div>
                <h3 className="font-bold text-[#0B1E5B] text-lg">{t.name}</h3>
      ...
      <section className="section-pad">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <div className="bg-[#0B1E5B] rounded-3xl p-8 md:p-12 text-center text-white relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <Link href="/safety" className="inline-flex items-center gap-2 bg-white text-[#0B1E5B] font-bold px-6 py-3 rounded-xl hover:bg-gray-50 transition-colors text-sm">
      ...
      <section className="section-pad bg-[#faf9f7]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl font-bold text-[#0B1E5B]">What Makes Us Different</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              ...
              <div key={item.title} className="bg-white rounded-3xl border border-gray-100 p-7 shadow-sm">
                ...
                <h3 className="font-bold text-[#0B1E5B] mb-2">{item.title}</h3>
