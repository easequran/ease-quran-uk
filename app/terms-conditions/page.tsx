    ...
    <>
      <div className="bg-gray-50 py-10">
        <div className="max-w-narrow mx-auto px-4 sm:px-6">
          ...
          <h1 className="text-3xl font-semibold text-navy-900 mt-4">Terms &amp; conditions</h1>
          <p className="text-gray-500 text-sm mt-1">Last updated: December 2024</p>
        </div>
      </div>

      <section className="section-pad">
        <div className="max-w-narrow mx-auto px-4 sm:px-6 [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:text-navy-900 [&_h2]:mt-8 [&_h2]:mb-3 text-gray-700 space-y-4">
          ...
          <p>Our child safeguarding approach is described in full on our <a href="/safety" className="text-orange-500">Child Safety page</a>. By enrolling a child in our classes, you agree to the safeguarding practices described there.</p>
          ...
          <h2>10. Contact</h2>
          <p>For any questions about these terms, contact us at <a href="mailto:info@easequran.co.uk" className="text-orange-500">info@easequran.co.uk</a>.</p>
        </div>
      </section>
    </>
  );
