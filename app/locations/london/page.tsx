...
export default function London() {
  return (
    <CityPageTemplate
      ...
      whyOnline="London has one of the largest Muslim communities in the UK, spread across dozens of boroughs from Tower Hamlets and Newham in the east to Brent and Harrow in the north west. But finding consistent, quality Quran education in a city this busy is genuinely difficult. Commuting to a madrassa after school means traffic, parking, and precious family time lost. With Ease Quran, a certified teacher arrives at your child's screen at the agreed time — every single week — without anyone leaving home. Families in Ilford, Croydon, Walthamstow, and right across London choose us for exactly this reason."
      localPoints={[
