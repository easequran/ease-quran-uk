    ...
    <>
      <div className="bg-gray-50 py-10">
        <div className="max-w-narrow mx-auto px-4 sm:px-6">
          ...
          <h1 className="text-3xl font-semibold text-navy-900 mt-4">Privacy policy</h1>
          <p className="text-gray-500 text-sm mt-1">Last updated: December 2024</p>
        </div>
      </div>

      <section className="section-pad">
        <div className="max-w-narrow mx-auto px-4 sm:px-6 prose prose-gray max-w-none [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:text-navy-900 [&_h2]:mt-8 [&_h2]:mb-3">
          ...
          <h2>6. Contact</h2>
          <p>If you have any questions about this privacy policy or how we handle your data, please contact us at <a href="mailto:info@easequran.co.uk" className="text-orange-500">info@easequran.co.uk</a>.</p>
        </div>
      </section>
    </>
  );
