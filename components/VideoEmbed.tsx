  ...
  return (
    <div className="card overflow-hidden">
      <div className="relative aspect-video bg-gray-900 cursor-pointer group" onClick={() => setPlaying(true)}>
        {playing ? (
          ...
          <>
            ...
            <img src={thumb} alt={`Video review — ${reviewer}`} className="absolute inset-0 w-full h-full object-cover" loading="lazy" />
      ...
      <div className="p-4">
        ...
        <p className="text-xs text-gray-500 mt-0.5">UK Student — Video Review</p>
      </div>
    </div>
  );
}
