...
export default function WhatsAppSticky() {
  ...
  return (
    <a
      ...
      className="fixed bottom-[76px] left-4 lg:bottom-6 lg:left-6 z-40 group flex items-center gap-3"
    >
      {/* Button */}
      <span className="relative flex items-center justify-center w-14 h-14 rounded-full bg-whatsapp shadow-lg transition-transform duration-[120ms] active:scale-[0.97]">
